...
public class SelectableHelper{
    ...
    public SelectableHelper(View view, DeleteListener listener) {
        ...
        cancelButton.setOnClickListener(v -> quitEditionMode());

        mEditButton = view.findViewById(R.id.edit_home);
        ...
        mSelectAllButton.setOnClickListener(v -> mAdapter.selectAll());

        mDeselectAllButton = view.findViewById(R.id.deselect_all);
        mDeselectAllButton.setOnClickListener(v -> mAdapter.deselectAll());

        mDeleteSelectionButton = view.findViewById(R.id.delete_item);
        mDeleteSelectionButton.setEnabled(false);

        mDeleteSelectionButton.setOnClickListener(v -> {
                    final Dialog dialog =
                            NurseCallUtils.getDialog(
                                    mContext,
