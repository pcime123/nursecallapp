...
public class LedSetting extends BasicSetting {
    ...
    LedSetting(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
        super(context, attrs, defStyleAttr, defStyleRes);
    }

    void inflateView() {
        Log.w("Jin", String.valueOf(LayoutInflater.from(getContext()).inflate(R.layout.settings_widget_led, this, true)));
