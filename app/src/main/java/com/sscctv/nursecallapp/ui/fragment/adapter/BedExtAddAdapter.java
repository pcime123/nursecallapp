...
public class BedExtAddAdapter extends RecyclerView.Adapter<BedExtAddAdapter.ViewHolder> {

    private static final String TAG = BedExtAddAdapter.class.getSimpleName();
    private List<ExtItem> items;
    private String idModel, idWard, idRoom, idBed;

    public BedExtAddAdapter(List<ExtItem> items) {
        this.items = items;
    }
