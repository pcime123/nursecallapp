...
import com.sscctv.nursecallapp.receivers.BluetoothReceiver;
...
//                                && mContext.getResources().getBoolean(R.bool.allow_ringing_while_early_media)
                        )) {
                        ...
                        if (state == Call.State.Connected) {
                            ...
                            if (core.getCallsNb() == 0) {
                                ...
                                if (mHeadsetReceiver != null && mHeadsetReceiverRegistered) {
                                    Log.i(TAG, "[Audio Manager] Unregistering headset receiver");
...
//    }
    ...
    private void enableHeadsetReceiver() {
        ...
        Log.i(TAG,"[Audio Manager] Registering headset receiver");
